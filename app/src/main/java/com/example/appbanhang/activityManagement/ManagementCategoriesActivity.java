...
import com.example.appbanhang.adapter.AdminCategoriesAdapter;
...
public class ManagementCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_management_categories);
    ...
    private void actionToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentMainManga = new Intent(getApplicationContext(), ManagementMainActivity.class);
